...
public class MainActivity extends AppCompatActivity
    ...
    private void createNewFolder_method() {
        String initialize = "新建文件夹";
        input_FolderName_ByCreateFolder =
                new InputNameDialog(MainActivity.this, createFileListener, initialize);
    ...
    private DialogInterface.OnClickListener delFiles_sure_listener
    ...
    private DialogInterface.OnClickListener delFiles_cancel_listener
            = new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
            setShowPattern();
        ...
        fileAdapter.setOnClickItem(new FileAdapter.onClickItem() {
            ...
            public void onClick(ArrayList<FileData> fileData, int position) {
                ...
                if (!isCheckPattern) {
                    ...
                    clickFiles(fileData, position, name);
                }
        ...
        fileAdapter.setOnLongClickItem(new FileAdapter.onLongClickItem() {
            ...
            public void onClick(ArrayList<FileData> fileData, int position) {
                ...
                if (!name.equals("<<previous>>")) {
                    if (!isCheckPattern) {
                        setCheckPattern(fileData, position);
                    }
                }
            }
        });
    ...
    private void clickFiles(ArrayList<FileData> fileData, int position, String name) {
    ...
    private void setCheckPattern(ArrayList<FileData> fileData, int position) {
        file_list = new ArrayList<>();
        fileAdapter.showCheck(position);
        isCheckPattern = true;
        checkedItemCount = 1;
